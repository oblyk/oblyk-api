  ...
  task :crags, %i[database out] => :environment do |_t, args|
    ...
    all_old_data.each do |data|
      ...
      sectors_data.each do |sector_data|
        ...
        sun = 'sunny_all_day' if sector_data[5] == 2
        sun = 'shady' if sector_data[5] == 3
        sun = 'sunny_afternoon' if sector_data[5] == 4
        sun = 'sunny_morning' if sector_data[5] == 5
