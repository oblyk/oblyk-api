...
class Grade
  ...
  GRADES_TO_VALUE = [
    ...
    # Grade like 3a
    /^(3a|5\.4|VB|III\+|B0|PD)$/, # 13 : 3a
    /^(3a\+|V0-)$/, # 14 : 3a+
    /^(3b|5\.5|V0|IV-|B1)$/, # 15 : 3b
    /^(3b\+|A0)$/, # 16 : 3b+
    /^(3c|V0\+|B2)$/, # 17 : 3c
    /^3c\+$/, # 18 : 3c+

    # Grade like 4a
    /^(4a|VD|5\.6|IV|AD-)$/, # 19 : 4a
    /^4a\+$/, # 20 : 4a+
    /^(4b|S|5\.7|V1|IV\+|AD)$/, # 21 : 4b
    /^(4b\+|A1)$/, # 22 : 4b+
    /^(4c|HS|V2|V-|B3|AD\+)$/, # 23 : 4c
    /^4c\+$/, # 24 : 4c+

    # Grade like 5a
    /^(5a|VS|5\.8|V\+|D-)$/, # 25 : 5a
    /^5a\+$/, # 26 : 5a+
    /^(5b|HVS|5\.9|V3|VI-|D)$/, # 27 : 5b
    /^(5b\+|A2)$/, # 28 : 5b+
    /^(5c|5\.10a|VI|D\+)$/, # 29 : 5c
    /^5c\+$/, # 30 : 5c+

    # Grade like 6a
    /^(6a|E1|5\.10b|VI\+|TD-)$/, # 31 : 6a
    /^(6a\+|5.10c|VII-|B4)$/, # 32 : 6a+
    /^(6b|E2|5\.10d|VII|TD|A3)$/, # 33 : 6b
    /^(6b\+|5\.11a|V4|VII\+|B5)$/, # 34 : 6b+
    /^(6c|E3|5\.11b|VIII-|TD\+)$/, # 35 : 6c
    /^(6c\+|5\.11c|V5|VIII|B6)$/, # 36 : 6c+

    # Grade like 7a
    /^(7a|E4|5\.11d|V6|VIII\+|B7|ED-)$/, # 37 : 7a
    /^(7a\+|E5|5.12a|V7|IX-|B8)$/, # 38 : 7a+
    /^(7b|5\.12b|B9|ED)$/, # 39 : 7b
    /^(7b\+|E6|5\.12c|V8|IX|B10|A4)$/, # 40 : 7b+
    /^(7c|5\.12d|V9|IX\+|B11|ED\+)$/, # 41 : 7c
    /^(7c\+|E7|5\.13a|V10|B12)$/, # 42 : 7c+

    # Grade like 8a
    /^(8a|5\.13b|V11|B13|ABO-)$/, # 43 : 8a
    /^(8a\+|E8|5.13c|V12|X-|B14)$/, # 44 : 8a+
    /^(8b|E9|5\.13d|V13|X|B15|ABO)$/, # 45 : 8b
    /^(8b\+|E10|5\.14a|V14|X\+|B16)$/, # 46 : 8b+
    /^(8c|5\.14b|V15|B17|ABO\+)$/, # 47 : 8c
    /^(8c\+|E11|5\.14c|V16|XI-|B18)$/, # 48 : 8c+

    # Grade like 9a
    /^(9a|5\.14d|XI|B19)$/, # 49 : 9a
